...
## Rough Approach
I first intend to identify the most appropriate AI model type for this problem. Then, I create a small sample model to test if the aproach works. Then, I gather and prepare the data to be fed into the model. Lastly, I fine-tune the model to achieve best results. 
